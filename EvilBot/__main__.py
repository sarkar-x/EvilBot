...
buttons = [
    [
     ...
     [
        ...
        InlineKeyboardButton(
            text="𝐌𝐲 𝐖𝐞𝐛🌐", url=f"http://supibotz.art.blog"
        ),
     ],
     [  
        InlineKeyboardButton(text="𝐒𝐮𝐩𝐩𝐨𝐫𝐭🛠", url="https://t.me/EVIL_SUPPORT_CHAT"),
        InlineKeyboardButton(text="𝐑𝐞𝐩𝐨🇮🇳", url="https://github.com/shrvan42/sarkarBot"),
    ], 
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("sarkarBot.modules." + module_name)
